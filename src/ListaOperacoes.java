/**
 * Interface que define operações avançadas para a manipulação de estruturas de lista baseadas em Strings.
 *
 * A implementação pode ser feita utilizando um array fixo (ListaSimples) ou
 * uma lista encadeada (ListaDinamica), respeitando o mesmo contrato de métodos.
 */
...
public interface ListaOperacoes {
     ...
     *
     * Exemplo:
     * Array: ["Emerson", "Ana", "Gabriel", "Ana"]
     * removerTodas("Ana")
     * Saída: ["Emerson", "Gabriel"]
     *
    ...
    /**
     * Retorna a quantidade total de elementos armazenados na lista.
     *
     * Esse metodo deve considerar apenas os elementos válidaos, ignorando posições vazias (null) no caso do array.
     *
     ...
     *
     * No caso da lista baseada em array, deve se respeitar o limite de capacidade. Caso não haja espaço suficiente,
     * apenas os elementos possíveis deverão ser adicionados.
     *
     * @param elementos Array de Strings contendo os elementos a serem adicionados.
